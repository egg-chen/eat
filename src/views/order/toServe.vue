...
export default {
  ...
  created() {
    this.findOrderByCustomerId({ status: this.queryParams.status });
    // findOrderByCustomerId({ status: this.queryParams.status });
    // this.findToServeData(this.queryParams);
  },
  mounted() {},
};
</script>
